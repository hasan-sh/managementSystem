...
function (_Component) {
  ...
  function ManagementSystem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDrop", function (e, targetCategoryId) {
      ...
      var draggedProject = e.dataTransfer.getData('draggedProject'); //  JSON.parse(draggedProject)
      // const projectId = e.dataTransfer.getData('id')

      console.log('on drop: ', targetCategoryId, fromCategoryId, JSON.parse(draggedProject));
      ...
      categories.splice(targetCategoryIndex, 1, targetCategory); // this.setState({ categories })
      // this.updateDB({ fromCategoryId, toCategoryId: id, projectId })
    });
...
//# sourceMappingURL=index.js.aa181ce086548e80c3f7.hot-update.js.map