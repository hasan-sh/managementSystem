...
function (_Component) {
  ...
  function Category() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Category).call(this)); // console.log('hallooo')

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dragStart", function (e, draggedProject, fromCategoryId) {
      console.log('setting state for', _this.props.category.name, draggedProject, fromCategoryId);
      e.dataTransfer.setData('id', draggedProject.id);
      e.dataTransfer.setData('fromCategoryId', fromCategoryId);
      e.dataTransfer.setData('draggedProject', JSON.stringify(draggedProject)); // this.setState({ draggedProject, fromCategoryId })
    });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        onDrop: function onDrop(e) {
          setTimeout(function () {
            console.log('From', _this2.props.category.name, _this2.state);
            console.log(_this2.state.draggedProject);
          }, 2000);

          _onDrop(e, category.id, _this2.state.fromCategoryId, _this2.state.draggedProject);
        },
        __source: {
        ...
        return (//   <div key={project.id} className={css.project}>
          //       </div>
          react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Project_js__WEBPACK_IMPORTED_MODULE_4__["default"], {
            key: project.id,
            project: project,
...
//# sourceMappingURL=index.js.e50a572227aad0b9813e.hot-update.js.map